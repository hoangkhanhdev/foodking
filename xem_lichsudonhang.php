...
<body class="nav-md">
    ...
    <div class="content-wrapper" style="min-height: 564px; width:800px;  ">
        <section class="content-header">
            <h1><i class=""></i> Chi tiết đơn hàng</h1>
            <div class="breadcrumb">
                <a class="btn btn-primary btn-sm" href="lichsudonhang.php" role="button">
                        ...
                        <div class="box-body">
                            ...
                            <div id="view">
                                ...
                                <form action="" enctype="" method="get" accept-charset="utf-8">
                                    ...
                                    <h3 class="text-center" style="color: red; font-size: 1.6em; ">CHI TIẾT ĐƠN HÀNG</h3>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-hover table-bordered">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td colspan="6" class="text-right"
                                                        style="border: none; font-size: 1.1em;">Voucher giảm giá : 0₫
                                                    </td>
                                                </tr>
