  ...
  <div class="form-container sign-in-container">
      <form action="register_submit.php" method="POST" role="form" >
        <br>
          ...
          <div style="display: flex; justify-content: space-around;"  class="group1-2">
            <div  class= "group">
            <label for="">Email</label>
               <input type="email" placeholder="Email" name="email" />
            </div>
            <div style=" padding-left: 10px;" class= "group">
         ...
         <div class= "group">
          ...
          <div style="display: flex;  " class="grop1">
          <div class= "group">
            <label for="">Ngày sinh</label>
             <input type="date"  name="ngaysinh" />
             
            </div>
            <div style="padding-left:10px;" class= "group-it">
            <label for="">Giới tính</label><br>
            <div style="display: flex;" class="gt">
  ...
  <div class="overlay-container">
      <div class="overlay">
          <div class="overlay-panel overlay-right">
              ...
              <a style="color: #eee;" href="index.php">Về trang chủ</a>
              <a href="dangnhap.php"><button class="ghost" id="">Đăng nhập</button></a>
          </div>
      </div>
  </div>
  <style>
